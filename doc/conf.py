...
# parts of eSCAPE. readthedocs can't compile or load this, so we mock it
# out.
...
project = 'eSCAPE'
copyright = '2019, Geodels - eSCAPE documentation'
...
latex_documents = [
    (master_doc, 'eSCAPE.tex', u'eSCAPE Documentation',
...
man_pages = [
    (master_doc, 'escape', u'eSCAPE Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'eSCAPE', u'eSCAPE Documentation',
     author, 'eSCAPE', 'One line description of project.',
     'Miscellaneous'),
]
